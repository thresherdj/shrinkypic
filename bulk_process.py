...
"""
This script will read a.csv file which contains picture file mapping and captions.
This script relys on ImageMagick to convert the picture to their final format.
It also uses the pngnq utility which handles the reduction of the PNG files
produced in the process. These two utilies are external and are called by the
python script to do their work.

AUTHOR: Dennis Drescher version: 2015.03.29
...
# Import libs
import sys, os, csv, codecs, shutil, argparse
